  ...
  betweenColWrapper = (beginFormItem, endFormItem, field) => {
    ...
    return (
      <Col key={`${field.key}Begin`} sm={8}>
        <Row>
          <Col span={16}>
            <FormItem extra={extra} key={`${field.key}Begin`} label={field.title} labelCol={{ span: 15 }} wrapperCol={{ span: 9 }} {...formItemProps}>
              {beginFormItem}
            </FormItem>
          </Col>
          <Col span={7} offset={1}>
            <FormItem extra={extra} key={`${field.key}End`} labelCol={{ span: 10 }} wrapperCol={{ span: 14 }} {...formItemProps}>
              {endFormItem}
            </FormItem>
          </Col>
        </Row>
      ...
      case 'datetime':
        ...
        cols.push(
          <Col key={`${field.key}Begin`} span={8}>
            <FormItem extra={extra} key={`${field.key}Begin`} label={field.title} labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} {...formItemProps}>
        ...
        cols.push(<Col key={`${field.key}End`} span={8}>
          <FormItem extra={extra} key={`${field.key}End`} labelCol={{ span: 6 }} wrapperCol={{ span: 18 }} {...formItemProps}>
            <DatePicker format="YYYY-MM-DD"
      ...
      case 'datetimes':
        ...
        cols.push(
          <Col key={`${field.key}`} span={16}>
            <FormItem extra={extra} key={`${field.key}`} label={field.title} labelCol={{ span: 3 }} wrapperCol={{ span: 18 }} {...formItemProps}>
