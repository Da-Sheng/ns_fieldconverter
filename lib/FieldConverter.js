  ...
  _createClass(FieldConverter, [{
    ...
    value: function internalConvert(option) {
      ...
      if (this.primaryKey === field.key) {
        ...
        return wrapper(_extends({}, obj.props.form.getFieldDecorator(field.key)(_react2.default.createElement(TextArea, _extends({ autosize: { minRows: 1, maxRows: 10 }, disabled: true,
          size: 'default' }, props)))), field);
      }
