...
var CheckboxConverter = function () {
  ...
  _createClass(CheckboxConverter, [{
    ...
    value: function transformCheckboxConverter(option) {
      ...
      return wrapper(_extends({}, obj.props.form.getFieldDecorator(field.key, fieldOptions)(_react2.default.createElement(CheckboxGroup, _extends({ options: defalutCheckOptions, onChange: obj.onCheckBoxChange }, props)))), field);
    }
  }]);
