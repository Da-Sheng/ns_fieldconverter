...
var ResponseDataConverter = function () {
  ...
  _createClass(ResponseDataConverter, [{
    ...
    value: function transformResponseData(option) {
      ...
      return wrapper(_extends({}, obj.props.form.getFieldDecorator(field.key, fieldOptions)(_react2.default.createElement(_antd.Input, { placeholder: field.placeholder, size: 'default', disabled: 'true' }))), field);
    }
  }]);
...
//# sourceMappingURL=ResponseDataConverter.js.map